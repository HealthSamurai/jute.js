...
var parser = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c31 = function() { return parseInt(text()); },
        peg$c32 = function() { return text(); },
        peg$c33 = function(p) { return p; },
        peg$c34 = "**",
        peg$c35 = { type: "literal", value: "**", description: "\"**\"" },
        peg$c36 = function() { return ['deepWildcard']; },
        peg$c37 = "*",
        peg$c38 = { type: "literal", value: "*", description: "\"*\"" },
        peg$c39 = function() { return ['wildcard']; },
        peg$c40 = function(e) { return ['expr', e]; },
        peg$c41 = function(e) { return ["pred", e]; },
        peg$c42 = "|>",
        peg$c43 = { type: "literal", value: "|>", description: "\"|>\"" },
        peg$c44 = function(filter) { return filter; },
        peg$c45 = function(filters) { return filters; },
        peg$c46 = function(name, args) {
            return {name: name, args: args || []};
          },
        peg$c47 = function(head, e) {return e;},
        peg$c48 = function(head, tail) { return [head].concat(tail); },
        peg$c49 = "+",
        peg$c50 = { type: "literal", value: "+", description: "\"+\"" },
        peg$c51 = "-",
        peg$c52 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c53 = function(fract) {
            if (fract) {
        ...
        peg$c54 = function(head, tail) { return ["array", head].concat(tail || {}); },
        peg$c55 = "true",
...
// Generated by CoffeeScript 1.10.0
var EVAL_TABLE, evalAst, evalExpression, evalPath, evalUnaryMinus, evalUnion, flatten, flattenRecur, isDeepWildcard, isPathExpression, isPredicate, isWildcard, mkEvalOp, putPathResult, resolveDeepWildcard, resolvePath, setToArray, toSet;
...
putPathResult = function(acc, res) {
  if (Array.isArray(acc.result)) {
    if (res !== null && res !== void 0) {
      return acc.result.push(res);
    }
  } else {
    return acc.result = res;
  }
};
...
resolvePath = function(scope, path, acc) {
  var item, j, k, l, len, len1, pathHead, pathTail, results, results1, results2, results3, v;
  pathHead = path[0];
