...
// Generated by CoffeeScript 1.10.0
var DEFAULT_DIRECTIVES, HELPERS, evalDirective, evalFilter, evalIf, evalJs, evalLet, evalMap, evalObject, evalString, evalSwitch, exports, firstKeyName, intersectArrays, isDirective, jute, nodeValue, transform;
...
jute.makeChildScope = function(scope) {
  var childScope;
  childScope = {};
...
jute.evalNode = function(node, scope, options) {
  var nodeType;
